...
Register-ScheduledTask -TaskName $taskName -Action $action -Trigger $trigger -Settings $settings -Description "KH Agrifarm 3-Minute RainPoint & Tapo T315 Telemetry Sync"

Write-Host "=========================================================================="
Write-Host "  SUCCESS: Background Task '$taskName' is now REGISTERED!"
Write-Host "=========================================================================="
Write-Host "  - Runs automatically every 3 minutes in the background."
